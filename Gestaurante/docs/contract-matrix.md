...
| Account action tokens | `AccountActionTokens` | One-use links for email confirmation and password reset |
| Customers | `UsuariosCliente` | Owns `ClienteDirecciones`, `ClienteMetodosPago`, legacy `ClienteEmailVerifications` |
...
| `AuthController` | Public | `AccountActionTokens`, `Empleados`, `UsuariosCliente` | `POST /auth/forgot-password`, `POST /auth/reset-password` |
...
| `/recuperar-password` | `Pages/PasswordRecovery.jsx` | `services/account-recovery.js` | `POST /auth/forgot-password` | public |
| `/restablecer-password` | `Pages/ResetPassword.jsx` | `services/account-recovery.js` | `POST /auth/reset-password` | public |
...
| `/cuenta/verificar-email` | `Pages/CustomerVerifyEmail.jsx` | `services/customer-account.js` | `POST /public/account/resend-confirmation-email` | public |
| `/cuenta/confirmar-email` | `Pages/CustomerConfirmEmail.jsx` | `services/customer-account.js` | `POST /public/account/confirm-email` | public |
